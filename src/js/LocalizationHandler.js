function Localizator() {
    ...
    this.defaultKey = {
        ...
        zoomIn: "Zoom in (>)",
        zoomOut: "Zoom out (<)",
        toggleSnap: "Turn snap on/off (ctrl+k)",
        ...
        inspector: "Inspector",
        nothingToInspect: "Select a component then your component details should appear here.",
        properties: "Properties",
        hierarchy: "Hierarchy",
        searchInHierarchy: "Search in hierarchy",
        ...
        addPolygonToolbar: "Add Polygon (j)",
        navigate: "Navigate",
        ...
        addPolygon: "Add Polygon (press esc to cancel)",
