export namespace LZString {
    ...
    var baseReverseDic: BaseReverseDic = {};

    interface BaseReverseDic {
        [key: string]: {
            [key: string]: number;
        };
    }
    ...
    interface GetCharFromInt {
        (value: number): string;
    }

    function _compress(uncompressed: string, bitsPerChar: number, getCharFromInt: GetCharFromInt): string {
    ...
    export function decompress(compressed:string) {
        ...
        // Define interface for the callback function
        interface GetNextValueFn {
            (index: number): number;
        }
    ...
    function _decompress(length: number, resetValue: number, getNextValue: GetNextValueFn): string | null {
